...
const QUESTIONS = [
 {
  ...
  "nSelect": 1,
  "merksatz": "Testziele: Fehler finden, Risiko senken, Vertrauen aufbauen – nie Fehlerfreiheit beweisen!",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Tester finden (Fehlerwirkung auslösen), Entwickler flicken (Debugging: Ursache suchen und beseitigen).",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Die 7 Grundsätze: Fehler zeigen ≠ Fehlerfreiheit beweisen · nie vollständig · früh testen · Fehler klumpen · Tests nutzen sich ab · kontextabhängig · 'fehlerfrei' ≠ brauchbar.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Der Testprozess: Planen – Überwachen/Steuern – Analysieren (WAS) – Entwerfen (WIE) – Realisieren – Durchführen – Abschließen.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Verfolgbarkeit verknüpft Anforderung ↔ Testfall ↔ Fehler: macht Überdeckung messbar und Auswirkungen von Änderungen sichtbar.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Rolle des Testens = analysiert, entwirft, führt aus; Testmanagementrolle = plant, koordiniert, berichtet an Stakeholder.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Unabhängige Tester sehen mehr (keine Betriebsblindheit), riskieren aber Isolation und Verantwortungsabschiebung.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Whole-Team-Ansatz: Qualität ist Teamverantwortung – jeder darf testen, Tester coachen dabei.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Gute Praxis in jedem Modell: Zu jeder Entwicklungsaktivität gehört eine Testaktivität, jede Teststufe hat eigene Ziele, Testanalyse beginnt schon bei den Anforderungen.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Test-First: Erst der Test, dann der Code – TDD (Unit-Tests), ATDD (Abnahmetests), BDD (Given-When-Then-Szenarien).",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Shift-Left: Testaktivitäten so früh wie möglich – Reviews von Anforderungen, frühe Testanalyse, Unit-Tests beim Coden.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Retrospektiven: Nach der Iteration fragen 'Was lief gut, was nicht, was ändern wir?' – kontinuierliche Prozessverbesserung.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Teststufen von klein nach groß: Komponente → Komponentenintegration → System → Systemintegration → Abnahme; jede mit eigener Testbasis und eigenen Zielen.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Wartungstest-Auslöser: Änderung (Hotfix, Update), Migration (neue Plattform, Daten) und Außerbetriebnahme (Archivierung).",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Statisches Testen findet Fehler früh und billig – die Ursache direkt im Dokument, bevor Code überhaupt läuft.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Frühes und häufiges Stakeholder-Feedback verhindert, dass am Bedarf vorbei entwickelt wird – Missverständnisse werden früh sichtbar.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Formalitäts-Treppe: informelles Review → Walkthrough (Autor führt) → technisches Review (Experten diskutieren) → Inspektion (formalster Prozess mit Metriken).",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Erfolgreiche Reviews: klare Ziele, passende Teilnehmer, genug Vorbereitungszeit – und immer das Werk kritisieren, nie den Menschen.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Black-Box = aus der Spezifikation (Verhalten), White-Box = aus der Struktur (Code), erfahrungsbasiert = aus dem Wissen des Testers.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Entscheidungstabelle: Spalten = Regeln (Bedingungskombination → Aktion); prüfe auf unmögliche Kombinationen, Lücken und Widersprüche.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Zustandsübergangstest: Zustände + Ereignisse = Übergänge; gültige Übergänge abdecken (alle Übergänge = stärker als alle Zustände), ungültige gezielt prüfen.",
  "explanation": "a) FALSCH – Für 100 % Überdeckung aller Übergänge müssten neben den gültigen Übergängen auch ungültige Übergänge, z. B. S1 → S3, auszuführen versucht werden. Dies geschieht durch die angegebenen Testfälle nicht.\n\nb) KORREKT – da alle 5 gültigen Übergänge ausgeführt werden.\n\nc) FALSCH – da alle gültigen Übergänge ausgeführt werden (siehe b).\n\nd) FALSCH – da es bei der 0-Switch-Überdeckung nicht auf die Überdeckung der Zustände, sondern der Übergänge ankommt."
 },
 {
  "id": "A-24",
  "set": "A",
  ...
  "nSelect": 1,
  "merksatz": "Anweisungstest: Wie viel Prozent aller Anweisungen wurden ausgeführt? 100 % Anweisungen ≠ alle Entscheidungen getestet.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "White-Box-Wert: misst, was WIRKLICH implementiert ist – findet Lücken, wo die Spezifikation schweigt; Schwäche: findet keine fehlenden Anforderungen.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Intuitive Testfallermittlung (Error Guessing): Der erfahrene Tester greift gezielt typische Fehlerquellen an – Erfahrung als Checkliste im Kopf.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Explorativ = gleichzeitig lernen, entwerfen und testen – oft in Sessions mit Test-Charter; ideal bei knapper Zeit oder dünner Spezifikation.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Akzeptanzkriterien: szenariobasiert (Given/When/Then) oder regelorientiert (Checkliste/Tabelle) – immer prüfbar formulieren.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "ATDD: Aus Akzeptanzkriterien werden VOR der Implementierung Testfälle – die Tests treiben die Entwicklung.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Tester in der Release-/Iterationsplanung: machen User-Storys testbar, schätzen Testaufwand, denken an Risiken – Qualität von Anfang an.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Eingangskriterien = Wann dürfen wir starten (Definition of Ready)? Endekriterien = Wann sind wir fertig (Definition of Done)?",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Schätzverfahren: metrikbasiert (Burndown, frühere Projekte), extrapolierend, Weitband-Delphi/Planning Poker (Experten), Dreipunkt: (O + 4W + P) / 6.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Testquadranten: Q1 = technisch/teamunterstützend (Unit), Q2 = fachlich/teamunterstützend (funktional), Q3 = fachlich/produktkritisierend (explorativ, UAT), Q4 = technisch/produktkritisierend (Performanz).",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Reaktionen auf Produktrisiken: Teststufen/Testverfahren wählen, Umfang festlegen, priorisieren, zusätzliche Maßnahmen (z. B. Reviews, Schulungen).",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Testberichte: Fortschrittsbericht (laufend, ans Team) vs. Abschlussbericht (am Ende, an Stakeholder) – Inhalt und Sprache an die Zielgruppe anpassen!",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Konfigurationsmanagement: Alle Testmittel und Testobjekte eindeutig identifiziert und versioniert – sonst weißt du nie, WAS du getestet hast.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Ein guter Fehlerbericht macht reproduzierbar: eindeutige ID, Titel, Umgebung, Schritte, erwartetes vs. tatsächliches Ergebnis – objektiv und vollständig.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Werkzeugtypen: Testmanagement (verwalten), statische Analyse (Code lesen), Testautomatisierung (ausführen/vergleichen), Performanz (Last erzeugen), CI (Pipeline).",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Automatisierung: nutzt bei Wiederholung (Regression, schnelles Feedback) – Risiken: unrealistische Erwartungen, Wartungskosten der Skripte, Werkzeuggläubigkeit.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Testen ist nötig, weil Fehler Geld, Zeit und Vertrauen kosten – je später gefunden, desto teurer.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "QS ist prozessorientiert (Fehler vermeiden), Testen ist produktorientiert (Fehler finden) – Testen ist ein Teil der Qualitätssicherung.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Testmittel = alles, was Testaktivitäten erzeugen: Konzept (Planung), Testfälle (Entwurf), Skripte (Realisierung), Berichte (Abschluss).",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Der Kontext (Branche, Risiko, Vorgehen, Regularien) bestimmt WIE getestet wird – es gibt keinen Einheitsprozess.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Gute Tester brauchen mehr als Technik: Kommunikation, kritisches Denken, Neugier und Fachwissen.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Das Entwicklungsmodell bestimmt das Testen: sequenziell = späte Teststufen, iterativ = testen in jeder Iteration + Regressionstests/Automatisierung.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "DevOps: CI/CD-Pipeline mit viel Automatisierung gibt schnelles Feedback – manuelle, nutzerorientierte Tests bleiben trotzdem nötig.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Reviewprozess: Planung → Review-Initiierung → individuelles Review (hier die meisten Funde!) → Kommunikation & Analyse → Fehlerbehebung & Berichterstattung.",
  "explanation": "a) FALSCH – \n\nb) FALSCH – \n\nc) FALSCH – \n\nd) KORREKT – Die korrekte Kombination ist: 1C, 2B, 3A, 4D."
 },
 {
  "id": "B-18",
  "set": "B",
  ...
  "nSelect": 1,
  "merksatz": "Review-Rollen: Moderator leitet, Autor erstellt und korrigiert, Gutachter finden, Protokollant notiert, Management stellt Ressourcen.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Checklistenbasiert: Erfahrungswissen in Listenform – konsistenter als frei, flexibler als Skript; Checklisten regelmäßig pflegen!",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Testmetriken: Fortschritt (durchgeführte Tests), Qualität (Fehlerdichte, Fehlerfindungsrate), Überdeckung, Kosten – objektiv statt Bauchgefühl.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Testmittel = alles, was Testaktivitäten erzeugen: Konzept (Planung), Testfälle (Entwurf), Skripte (Realisierung), Berichte (Abschluss).",
  "explanation": "a) KORREKT – Die richtige Übereinstimmung ist: 1B, 2D, 3C, 4A\n\nb) FALSCH – \n\nc) FALSCH – \n\nd) FALSCH – "
 },
 {
  "id": "C-6",
  "set": "C",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Fehlernachtest fragt: Ist der Fehler wirklich weg? Regressionstest fragt: Ist etwas anderes dabei kaputtgegangen?",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Das Testkonzept beantwortet: Was, wie, wer, wann, womit – und wann sind wir fertig (Endekriterien)?",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Testpyramide: unten viele schnelle, kleine Tests (Unit), oben wenige langsame, große (UI/E2E) – Isolation nimmt nach oben ab.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Produktrisikoanalyse steuert das Testen: hohes Risiko = früher, gründlicher, mit mehr Teststufen und Techniken testen.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Die Kette: Grundursache → Fehlhandlung (Mensch) → Fehlerzustand (Code) → Fehlerwirkung (Laufzeit).",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Testarten: funktional (WAS es tut), nicht-funktional (WIE GUT: Performanz, Usability, Sicherheit), Black-Box, White-Box.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Reviewen kann man fast alles, was lesbar ist: Anforderungen, Code, Testware, Verträge, Handbücher – Voraussetzung ist eine lesbare Struktur.",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "User-Storys gemeinsam schreiben (3 C: Card, Conversation, Confirmation) – Tester bringen die kritische Qualitätssicht ein (INVEST-Kriterien).",
 ...
 },
 {
  ...
  "nSelect": 1,
  "merksatz": "Risikostufe = Eintrittswahrscheinlichkeit × Schadensausmaß.",
  "explanation": "a) FALSCH – \n\nb) KORREKT – \n\nc) FALSCH – FALSCH"
 },
 {
  "id": "D-35",
  ...
  "nSelect": 2,
  "merksatz": "Projektrisiko bedroht den Projekterfolg (Termine, Budget, Personal), Produktrisiko die Produktqualität (Fehlfunktion, Sicherheitslücke).",
